...
These Terms of Service ("Terms") govern your access to and use of the Maxxd mobile application and related services (collectively, the "App" or "Service").
...
Features may change over time, and we may introduce new features, modify existing features, or discontinue features at our discretion.
...
## 4. Health, Fitness, and Medical Disclaimers
...
## 6. AI-Based Food Scanning and Calorie Estimates

Maxxd uses AI and computer vision models to analyze images you capture with your camera or upload from your device to estimate the nutritional content of food ("AI Scanning Features").
...
## 7. Assumption of Risk and Exercise at Your Own Risk

You understand and agree that all exercise and physical activity recommended or logged in the App are performed entirely at your own risk. Physical training carries inherent risks, including serious injury or death.
...
## 8. Health Data and Third-Party Integrations
...
## 11. Camera and Photo Permissions
...
## 12. Paid Features, Subscriptions, and Trials
...
Except for the limited license granted in Section 5, we reserve all rights not expressly granted in these Terms.
...
Some users (for example certain EEA/UK consumers) may have non-waivable rights under local law to bring disputes in their local courts.
